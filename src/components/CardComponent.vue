        ...
        <router-link to="/sculpturessrb">
          <b-card img-left class="text-left card-component">
            <img
              ...
              class="card-image"
            />
            <b-card-title class="mt-5"><h2>Vajarstvo</h2></b-card-title>
          </b-card>
        </router-link>
      </div>
    </div>
        ...
        <router-link to="/architecturesrb">
          <b-card img-left class="text-left card-component">
            <img
              ...
              class="card-image"
            />
            <b-card-title class="mt-5"><h2>Arhitektura</h2></b-card-title>
          </b-card>
        </router-link>
      </div>
      <div class="col-md-6 mb-4">
        <router-link to="/exhibitionsrb">
          <b-card img-left class="text-left card-component">
            <img
              ...
              class="card-image"
            />
            <b-card-title class="mt-5"><h2>Izložba</h2></b-card-title>
          </b-card>
        </router-link>
      </div>
    </div>
